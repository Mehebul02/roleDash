...
import { Visibility, VisibilityOff, Email, Lock, ErrorOutline, Store } from "@mui/icons-material"
...
const LoginForm: React.FC<LoginFormProps> = ({
  ...
  identifierType = "text",
  identifierIcon = <Email color="action" />,
}) => {
  ...
  return (
    <Box component="form" onSubmit={handleLogin} sx={{ width: "100%" }}>
      ...
      <TextField
        ...
        InputProps={{
          startAdornment: <InputAdornment position="start">{identifierIcon}</InputAdornment>,
        }}
        sx={{ mb: 2 }}
        required
      />
